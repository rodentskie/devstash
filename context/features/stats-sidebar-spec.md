...
Show the stats in the main area from the data in the database instead of the @/lib/mock-data file. 
...
- Create apps/app/src/lib/db/items.ts and add the database functions.Use the collections file for reference if needed


## References

- apps/app/src/lib/db/collections.ts
